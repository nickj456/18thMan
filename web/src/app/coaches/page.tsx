  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
        <a href="https://www.facebook.com/profile.php?id=61574377776230" target="_blank" rel="noopener noreferrer" className="social-link">
        ...
        <a href="https://www.instagram.com/18th.man/" target="_blank" rel="noopener noreferrer" className="social-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
