...
export const metadata = {
  title: 'Contact Us — 18th Man',
  description: 'Get in touch with the 18th Man team. Questions, feedback, or partnership enquiries — we\'d love to hear from you.',
  ...
  openGraph: {
    ...
    title: 'Contact Us — 18th Man',
    description: 'Get in touch with the 18th Man team. Questions, feedback, or partnership enquiries — we\'d love to hear from you.',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: '18th Man — Contact Us' }],
  },
  twitter: {
